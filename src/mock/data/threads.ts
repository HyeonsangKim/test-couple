...
export const MOCK_THREADS: ThreadMessage[] = [
  {
    ...
    placeId: 'place_1',
    authorId: 'user_me',
    content: '여기 파스타가 진짜 맛있었어! 다음에 또 가자 🍝',
  ...
  },
  {
    ...
    content: '응응 나는 리조또도 좋았어~ 디저트도 꼭 먹어보자',
  ...
  },
  {
    ...
    placeId: 'place_2',
    authorId: 'user_me',
    content: '100일 기념으로 다시 왔는데 날씨가 완벽했어',
  ...
  },
  {
    ...
    placeId: 'place_8',
    authorId: 'user_me',
    content: '우리만 아는 비밀 장소 ❤️',
    createdAt: '2024-03-01T19:30:00Z',
    updatedAt: '2024-03-01T19:30:00Z',
  },
  {
    id: 'msg_9',
    placeId: 'place_8',
    authorId: 'user_partner',
    content: '여기서 본 노을이 제일 예뻐',
    createdAt: '2024-05-15T20:30:00Z',
    updatedAt: '2024-05-15T20:30:00Z',
  },
  {
    id: 'msg_10',
    placeId: 'place_10',
    authorId: 'user_me',
    content: '여기 없어졌나봐... 아쉽다',
